package ATripToObjectville.TheGuessingGame;
...
public class GuessGame {
     ...
     * variables for the three Player objects
     */
    Player p1;
    Player p2;
    Player p3;
    ...
    public void startGame() {
         ...
         * assign them to the three Player instance variable
         * */
        p1 = new Player();
        p2 = new Player();
        p3 = new Player();
        ...
        /**
         * declare three variables to hold a true
         * or false based on the player’s answer
         * */
